...
* EncodeFilter - криптира/кодира входен текстов файл с по избран от вас начин
...
2. ByteUnescapeFilter прави обратният процесс на ByteEscapeFilter-а, той трябва да възтанови escpae-натото съдържание. Това естествено е вярно ако и двата филтъра са били конструирани със еднакъв byte.
