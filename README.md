...
За класа Deck предефинирайте следните оператори:
	...
	operator== - проверява дали сборът от атаката и сборът на живота на картите на 2 дека е еднакъв
	operator!= - проверява дали сборът от атаката или живота на картите в 2 дека се различава
