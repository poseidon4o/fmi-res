...
* ZeroUnescapeFilter
  * работи върху бинарни файлове направени от ByteEscapeFilter
  * изхода е бинарен и е същият какъвто е бил преди да премине през ByteEscapeFilter

Пояснения:
 1. ZeroUnescapeFilter прави обратният процес на ByteEscapeFilter-а, той трябва да възтанови escpae-натото съдържание.
