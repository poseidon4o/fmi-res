...
*	- Warrior - тази карта освен ,че нанася щети на срещуположната карта удря и героя със същата щета.
*	- Hero - главна карта за всеки дек тя не участва в битката единствено дава определен бонус на всич*ки карти на бойното поле.Също така трябва да притежава енергия.
*	- HeroSkill - умение на каратите от тип Hero (само и единствено тяхно).Всеки герой притежава едно умение.
*	- по ваш избор направете 3 умения наследяващи Hero Skill (например увеличава живота, атаката или намалява необходимата енергия).
		
Имплементирайте класа BattleField - арената за битки. На арената трябва да има по един дек и герой за всеки играч.
Играчите притежават и карти на бойното поле(извадени от дека).Всяка карта на която необходимата енергия е по-малка от енергията притежавана от героят се изважда автоматично на бойното поле.Прилагат се бонусите от картата герой.След като двамата играчи са извадили картите които могат да бъдат извадени текущия рунд енергия на всеки от героите се увеличава с определена константа.Започва битката, всяка карта удря нейната срещуположна. Ако с/у нея няма карта - удря по картата герой на противника.
