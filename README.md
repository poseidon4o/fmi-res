...
Добавете в сегашната йерархия клас SortFilter който трябва да връща редовете от входа сортирани лексикографски. Демонстрирайте как поне 3 от филтрите работят в един FilterChain обект последователно.
