...
Съставете подходяща йерархия от следните класове
	- Guard - това е карта която поема всички щети нанесени от противника.
	- Warrior - тази карта освен ,че нанася щети на срещоположната удря и героя със същатата щета.
	- Hero - главна карта за всеки дек тя не участва в битката единствено дава определен бонус на всички карти на бойното поле.Също така трябва да притежава енергия.
	- HeroSkill - умение на каратите от тип Hero (само и единствено тяхно).Всеки герой притежава едно умение.
	- по вап избор направете 3 умения наследяващи Hero Skill (например увеличава живота, атаката или намалява необходимата енергия).
		
Имплементирайте класа BattleField - аранета за битки. На арената трябва да има по един дек и герой за всеки играч.
Също така притежават и карти на бойното поле(извадени от дека).В началото всеки от играчите притежава декът си.
Всяка карта на която необходимата енергия е по-малка от енергията притежавана от героят се изважда автоматично на бойното поле.
Прилагат се бонусите от картата герой.
След като двамата играчи са извадили картите които могат да бъдат извадени текущия рунд енергия на всеки от героите се увеличава с определена константа.
Започва битката, всяка карта удря нейната срещоположна. Ако с/у нея няма карта - удря по картата герой на противника.
Тои цикъл се извърта докато единия играч не загуби всички свои карти или героят му не умре.
