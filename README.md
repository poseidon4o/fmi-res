...
Съставете подходяща йерархия от следните класове
	...
	- Warrior - тази карта освен ,че нанася щети на срещоположната карта удря и героя със същатата щета.
...
Имплементирайте класа BattleField - арената за битки. На арената трябва да има по един дек и герой за всеки играч.
Играчите притежават и карти на бойното поле(извадени от дека).Всяка карта на която необходимата енергия е по-малка от енергията притежавана от героят се изважда автоматично на бойното поле.Прилагат се бонусите от картата герой.След като двамата играчи са извадили картите които могат да бъдат извадени текущия рунд енергия на всеки от героите се увеличава с определена константа.Започва битката, всяка карта удря нейната срещоположна. Ако с/у нея няма карта - удря по картата герой на противника.
Това действие се извършва докато единият играч не загуби всички свои карти или героят му не умре.
