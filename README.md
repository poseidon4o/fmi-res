...
**Домашно 4.** Съставете подходяща йерархия от следните класове
...
* BattleField-a трябва да може да бъде конструиран чрез сериализирания байт масив (без да му се подава игнорираният байт).
