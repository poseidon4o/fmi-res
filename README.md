...
*  Имплементирайте клас Skill който представлява умение на карта. Всяко умение може да въздейства на една или повече свой или противникови който са на полето или в гробището. Класа Skill трябва да има голямата четворка както и метод приема като аргумент бойното поле, списък с позиците на картите върху който ще въздеиства.
